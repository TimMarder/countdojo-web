    ...
    <div className="min-h-screen bg-gray-900 text-white">
      ...
      <nav className="px-6 py-4 border-b border-gray-800">
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          ...
          <div className="flex items-center gap-8">
            ...
            <a href="#screenshots" className="text-gray-400 hover font-medium transition">:text-white text-smScreenshots</a>
      ...
      <section className="px-6 py-24 text-center max-w-2xl mx-auto">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          ...
          <a href="#" className="bg-gray-800 hover:bg-gray-700 px-8 py-3.5 rounded-xl font-medium text-sm transition flex items-center justify-center gap-3">
            <svg className="w-5 h-5" viewBox="0 0 24 24" fill="currentColor">
              <path d="M3.609 1.814L13.792 12 3.61 22.186a.996.996 0 01-.609-.814V2.628a1 1 0 01.609-.814zm10.89 10.893l2.302 2.302-10.937 6.333 8.635-8.635zm3.199-3.198l2.807 1.626a1 1 0 010 1.73l-2.808 1.626L15.206 12l2.492-2.491z"/>
            </svg>
      ...
      <section id="features" className="px-6 py-24 bg-gray-800/30">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            />
            <FeatureCard 
              icon={<svg className="w-7 h-7" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M15.05 5A5 5 0 0119 5m0 0a5 5 0 011.27 9.76l-6.37 6.37a1.5 1.5 0 01-2.12 0l-4.12-4.12a1.5 1.5 0 012.12-2.12l3.37 3.37A5 5 0 0112.95 5H15z" /></svg>}
              title="Gamification"
      ...
      <section id="screenshots" className="px-6 py-24">
        <div className="max-w-sm mx-auto">
          ...
          <p className="text-gray-400 text-center mb-10">Beautiful, intuitive design</p>
          ...
          <div className="relative">
            ...
            <div className="flex justify-center items-center gap-4 mt-6">
              <button onClick={prevSlide} disabled={isAnimating} className="w-11 h-11 rounded-full bg-gray-800 hover:bg-gray-700 flex items-center justify-center transition disabled:opacity-50">
              ...
              <button onClick={nextSlide} disabled={isAnimating} className="w-11 h-11 rounded-full bg-gray-800 hover:bg-gray-700 flex items-center justify-center transition disabled:opacity-50">
                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" /></svg>
              </button>
            </div>
            
            <p className="text-center text-gray-500 text-xs mt-4">{currentSlide + 1} of {screenshots.length}</p>
          </div>
        </div>
      </section>
      ...
      <section className="px-6 py-20 bg-emerald-600">
        <div className="max-w-2xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a href="#" className="bg-white text-emerald-600 px-8 py-3.5 rounded-xl font-medium text-sm hover:bg-emerald-50 transition">Download on App Store</a>
            <a href="#" className="bg-emerald-700 text-white px-8 py-3.5 rounded-xl font-medium text-sm hover:bg-emerald-800 transition">Get it on Google Play</a>
          </div>
        </div>
      </section>
      ...
      <footer className="px-6 py-6 bg-gray-900 border-t border-gray-800">
        <div className="max-w-6xl mx-auto flex flex-col md:flex-row justify-between items-center gap-4">
          <Image src="/images/Count Dojo Banner Transparent Background.png" alt="Count Dojo" width={160} height={32} className="h-auto" />
